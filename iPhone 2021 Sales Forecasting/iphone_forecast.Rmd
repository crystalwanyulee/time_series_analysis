...
colnames(final_results) = c('Quarter', 'Actual Sales 2019', 'Sales Forecast 2021', 'Forecast SD') 
...
par(mfrow = c(3, 1))
plot(iphone_ts, main='iPhone Sales', ylab='log_sales', xlab='')
plot(diff(log_iphone_ts, 4), 
     main='iPhone Sales (Seasonally Adjusted)', 
     ylab='log_sales', xlab='', col='blue')
plot(diff(diff(log_iphone_ts, 4), 1), 
     main='iPhone Sales (Seasonally Adjusted and Trend Removed)', 
     ylab='log_sales', xlab='', col='red')
```

```{r fig.height=8, fig.width=8}
par(mfrow = c(3, 1))
Acf(log_iphone_ts)
Acf(diff(log_iphone_ts,4), main='Seasonally Adjusted')
Acf(diff(log_iphone_ts,1), main='Trend Removed')
```
